    ...
    try:
        ...
        if data is not False:
            ...
            for key, sell in sell_data.items():
                ...
                print("\nSELL\n")
                print(day_data, "\n")
                print("Open: {}, Close: {}, Day's High: {}, Day's Low: {}".format(
            ...
            print("Total 'Buy Call': {}".format(total_buy))
            print("Total 'Buy Call' Hold till End: {}".format(total_buy_success))
            ...
            print("Total 'Sell Call': {}".format(total_sell))
            print("Total 'Sell Call' Hold till End: {}".format(total_sell_success))
